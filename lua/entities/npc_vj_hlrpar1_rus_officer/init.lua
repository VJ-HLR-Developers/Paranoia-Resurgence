...
-----------------------------------------------*/
ENT.Model = "models/vj_parr/par1/npc_officer.mdl"
...
function ENT:Civilian_Voice()
    ...
    self.SoundTbl_IdleDialogueAnswer = {
        ...
        "vj_parr/par1/npc/army/happens.wav",
    ...
    self.SoundTbl_OnPlayerSight = {
        ...
        "vj_parr/par1/npc/army/camesklad1.wav",
        "vj_parr/par1/npc/army/konferents_zal.wav"
    }
...
function ENT:Civilian_Init()
    ...
    self:SetBodygroup(2, math_random(0, 2))
