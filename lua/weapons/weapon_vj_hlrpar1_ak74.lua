...
local validModels = {
    ...
    ["models/vj_parr/par1/soldier_clon2.mdl"] = true,
    ["models/vj_parr/par1/soldier_clon_bio2.mdl"] = true,
    ["models/vj_parr/par1/soldier_clon_heavy2.mdl"] = true,
