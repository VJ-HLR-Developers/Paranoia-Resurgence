...
SWEP.WorldModel = "models/vj_parr/par1/weapons/w_glock.mdl"
SWEP.HoldType = "pistol"
    -- World Model ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.WorldModel_UseCustomPosition = true
SWEP.WorldModel_CustomPositionAngle = Vector(180, 165, 90)
SWEP.WorldModel_CustomPositionOrigin = Vector(-3, 5, 0)
SWEP.WorldModel_CustomPositionBone = "Bip01 R Hand"
    -- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Primary.Damage = 8
SWEP.Primary.ClipSize = 17
SWEP.Primary.Ammo = "Pistol"
SWEP.Primary.Sound = "VJ.PARR1_Glock17.Single"
...
-- Custom
local validModels = {
    ["models/vj_parr/par1/diversant_pistol.mdl"] = true
}
SWEP.Reload_Start = "vj_parr/par1/weapons/glock/g_clipout1.wav"
SWEP.Reload_Middle = "vj_parr/par1/weapons/glock/g_clipin1.wav"
