...
SWEP.WorldModel = "models/vj_parr/par1/weapons/w_groza.mdl"
SWEP.HoldType = "smg"
    -- World Model ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.WorldModelOffsetParams = {
    Enabled = true,
    Bone = "Bip01 R Hand",
    Pos = Vector(3.864, 1.035, -0.5),
    Ang = Angle(0, 15, -90)
}
    -- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
...
SWEP.Primary.Sound = "VJ.PARR1_Groza.Single"
    ...
    timer.Simple(0.1, function()
        if IsValid(self) && IsValid(self:GetOwner()) && VJ.HLR_Weapon_CheckModel(self, validModels) then
            ...
            if self:GetOwner():GetModel() == "models/vj_parr/par1/early/soldier_alpha.mdl" then
                self.WorldModel = "models/vj_parr/par1/weapons/early/w_groza.mdl"
            end
        end
    end)
end
