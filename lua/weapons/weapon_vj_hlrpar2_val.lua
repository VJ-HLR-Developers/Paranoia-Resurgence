...
SWEP.WorldModelOffsetParams = {
    Enabled = true,
    Bone = "bip01_r_hand",
    Pos = Vector(9.955, -1.123, 0.522),
    Ang = Angle(-2.945, -11.015, -89.427)
}
    -- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Primary.Damage = 12
SWEP.Primary.ClipSize = 30
SWEP.Primary.Ammo = "SMG1"
SWEP.Primary.Sound = "VJ.PARR2_VAL.Single"
...
SWEP.Reload_Start = "vj_parr/par2/weapons/val/vss_out.wav"
SWEP.Reload_Middle = "vj_parr/par2/weapons/val/vss_in.wav"
SWEP.Reload_Finish = "vj_parr/par2/weapons/val/vss_boltpull.wav"
